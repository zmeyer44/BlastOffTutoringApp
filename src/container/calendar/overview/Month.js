...
import './style.css';
import { eventVisible, eventAdd, eventDelete } from '../../../redux/firebase/Calendar/actionCreator';
...
const MonthCalendar = props => {
  ...
  const { date, container, currentLabel, width, defaultValue, events } = state;
