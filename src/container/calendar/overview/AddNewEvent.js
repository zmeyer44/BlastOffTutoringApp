...
import { Col, Row, DatePicker, TimePicker, Form, Input, Radio, Select } from 'antd';
...
const AddNewEvent = ({ defaultValue, onHandleAddEvent }) => {
  ...
  const handleSubmit = values => {
    onHandleAddEvent({
      ...
      time: [state.startTime.format('h:mm a'), state.endTime.format('h:mm a')],
      type: values.type,
      label: values.label,
    });
    form.resetFields();
            ...
            <Row>
              ...
              <Col sm={20} xs={24}>
                <div className="date-time-picker d-flex">
                  ...
                  />
                  <DatePicker onChange={onChangeStartTime} picker="time" format="h:mm a" minuteStep={15} />
                </div>
              </Col>
            </Row>
          </div>
            ...
            <Row>
              ...
              <Col sm={20} xs={24}>
                <div className="date-time-picker d-flex">
                  ...
                  />
                  <DatePicker onChange={onChangeEndTime} picker="time" format="h:mm a" minuteStep={15} />
                </div>
              </Col>
            </Row>
          </div>
