...
const Overview = () => {
  ...
  return (
    <Row gutter={25}>
      ...
      <Col xs={24}>
        <PerformanceChartWrapper style={{ minHeight: '86px' }}>
          {performanceState !== null && (
            <Cards more={moreContent} title="Hours Saved" size="default">
      ...
      <Col xs={24}>
        <ProductOverviewTable>
          <Cards more={moreContent} title="My Sessions" size="default">
