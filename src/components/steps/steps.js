  ...
  return !isswitch ? (
    ...
    <>
      ...
      >
        {steps !== undefined &&
          steps.map(item => (
            <Step className={item.className && item.className} icon={item.icon && item.icon} key={item.title} />
          ))}
      </StepsStyle>
      {isvertical ? (
        <div className="steps-wrapper">
          <div className="steps-content" style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                    ...
                    <Col xs={24}>
                      <div className="steps-action">
                        ...
                        {state.currents < steps.length - 1 && (
                          <Button className="btn-next" type="primary" onClick={() => next()} htmlType="submit">
                            Save & Next
        ...
        <>
          <div className="steps-content" style={{ display: 'flex', justifyContent: 'center', marginTop: 40 }}>
            {steps[state.currents].content}
          </div>
