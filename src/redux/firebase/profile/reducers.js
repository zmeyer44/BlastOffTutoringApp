...
const fsProfileReducer = (state = initialState, action) => {
...
const fsSingleProfileReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { fsProfileReducer, fsSingleProfileReducer };
